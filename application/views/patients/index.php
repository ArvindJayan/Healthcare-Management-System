                ...
                <form action="<?= site_url('patients'); ?>" method="GET" class="row g-2 align-items-center">
                    <div class="col">
                        <div class="input-group">
                            ...
                            <input type="text" name="search" class="form-control focus-ring focus-ring-danger"
                                ...
                                <?php foreach ($patients as $p): ?>
                                    <tr>
                                        ...
                                        <td class="text-end pe-4">
                                            <button class="btn btn-sm btn-outline-danger me-1 btn-view-patient fw-semibold"
                                                data-id="<?= $p->id; ?>" data-bs-toggle="modal"
                                                data-bs-target="#viewPatientModal">
                                                View
                                            </button>
                                            <a href="<?= site_url('patients/edit/' . $p->id); ?>"
